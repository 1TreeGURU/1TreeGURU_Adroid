...
class ReviewWriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_submit.setOnClickListener(){
            ...
            addIntent.putExtra(HomeFragment.BOOK_PHOTO, editPhoto.text.toString())
            addIntent.putExtra(HomeFragment.BOOK_TITLE, editBookTitle.text.toString())
            addIntent.putExtra(HomeFragment.BOOK_AUTHOR, editAuthor.text.toString())
            addIntent.putExtra(HomeFragment.BOOK_DATE, editDate.text.toString())
            addIntent.putExtra(HomeFragment.BOOK_CONTENT, editContent.text.toString())
